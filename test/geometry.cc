...
int main(int argc, char** argv)
{
  ...
  std::cout << "Polygons:" << std::endl;
  {
    ...
    std::vector<pPoint> pe;
    pe.push_back(pPoint(0, 0));
    pe.push_back(pPoint(10, 0));
    pe.push_back(pPoint(10, 10));
    pe.push_back(pPoint(0, 10));

    Polygon poly(pe.begin(), pe.end());
    pPoint p(20, 20);

    assert(!bp::inside(poly, p));
    std::cout << " OK" << std::endl;
    ...
    std::cout << " [Test 4]";
    Segment res = bp::intersect_with(poly, Segment({5, 5}, {15, 5}));
    assert((res.p1() == (Point) {10, 0}));
    assert((res.p2() == (Point) {10, 10}));
    std::cout << " OK" << std::endl;

    std::cout << " [Test 5]";
    res = bp::intersect_with(poly, Segment({5, 5}, {5, 15}));
    assert((res.p1() == (Point) {10, 10}));
    assert((res.p2() == (Point) {0, 10}));
    std::cout << " OK" << std::endl;

    std::cout << " [Test 6]";
    res = bp::intersect_with(poly, Segment({-5, 5}, {5, 5}));
    ...
    pe.clear();
    pe.push_back(pPoint(8.01938, 9.62406));
    pe.push_back(pPoint(8.03969, 9.65656));
    pe.push_back(pPoint(7.95438, 9.86781));
    pe.push_back(pPoint(7.865, 10.0791));
    pe.push_back(pPoint(7.73906, 10.0669));
    pe.push_back(pPoint(7.61719, 10.0547));
    pe.push_back(pPoint(7.62531, 9.95312));
    pe.push_back(pPoint(7.6375, 9.85156));
    pe.push_back(pPoint(7.78781, 9.7175));
    pe.push_back(pPoint(7.93406, 9.5875));
    pe.push_back(pPoint(7.96656, 9.5875));
    pe.push_back(pPoint(7.99906, 9.5875));
    pe.push_back(pPoint(8.01938, 9.62406));
    poly = Polygon(pe.begin(), pe.end());

    pSegment s1(pPoint(8.01938, 9.62406), pPoint(8.01938, 9.62406));
    assert(bp::euclidean_distance(s1, pPoint(8.03189, 9.64406)) < PRECISION);
    std::cout << " [Test 8]";
    assert(bp::inside(poly, pPoint(8.03189, 9.64409)));
    std::cout << " OK" << std::endl;

    std::cout << " [Test 9]";
    assert(!bp::inside(poly, pPoint(8.03204, 9.6443)));
    std::cout << " OK" << std::endl;

    pe.clear();
    pe.push_back(pPoint(6.72344, 0.154375));
    pe.push_back(pPoint(6.64219, 7.21645e-17));
    pe.push_back(pPoint(6.51219, 7.21645e-17));
    poly = Polygon(pe.begin(), pe.end());

    std::cout << " [Test 10]";
    assert(bp::inside(poly, pPoint(6.64591, 0.00707282)));
    std::cout << " OK" << std::endl;
  }

  {
    std::vector<pPoint> pe;
    pe.push_back(pPoint(0, 0));
    pe.push_back(pPoint(5, 5));
    pe.push_back(pPoint(5, 0));
    ...
    std::cout << " [Test 11]";
    Segment res = bp::intersect_with(poly, Segment({3.1, 3}, {-2, 8}));
    assert((res.p1() == (Point) {0, 0}));
  ...
  {
    std::vector<pPoint> pe;
    pe.push_back(pPoint(116.984, 93.7433));
    pe.push_back(pPoint(115.518, 117.399));
    pe.push_back(pPoint(102.054, 129.746));
    pe.push_back(pPoint(50.6049, 129.478));
    pe.push_back(pPoint(50.4045, 120.423));
    pe.push_back(pPoint(100.731, 120.958));
    pe.push_back(pPoint(107.592, 112.292));
    pe.push_back(pPoint(108.323, 96.5429));
    pe.push_back(pPoint(96.8922, 86.4158));
    pe.push_back(pPoint(51.965, 86.8721));
    pe.push_back(pPoint(53.1677, 78.5918));
    pe.push_back(pPoint(99.3132, 78.0573));
    pe.push_back(pPoint(116.984, 93.7433));
    std::vector<Polygon> holes;
    CompoundPolygon u_poly(pe.begin(), pe.end(), holes.begin(), holes.end());
    PolygonCollider poly_collider(u_poly);

    std::cout << " [Test 1]";
    pPoint pp(107.65, 109.702);
    assert(!bp::inside(u_poly, pp));
    std::cout << " OK" << std::endl;

    std::cout << " [Test 2]";
    Segment s1 = Segment({108.0070, 110.005}, {107.65, 109.7});
    Segment s2 = bp::intersect_with(u_poly, s1);
    ...
    s2 = bp::intersect_with(u_poly, s1);
    Point p = Segment::intersection_point(s1, s2);
    ...
    std::cout << " [Test 6]";
    s1 = Segment({50.738, 129.225}, {49.3731, 130.11});
    assert(bp::inside(u_poly, pPoint(s1.p1()[0], s1.p1()[1])) &&
	   !bp::inside(u_poly, pPoint(s1.p2()[0], s1.p2()[1])));
    std::cout << " OK" << std::endl;
    ...
    s2 = bp::intersect_with(u_poly, s1);
    p1 = Segment::intersection_point(s1, s2);
    assert(bp::inside(u_poly, pPoint(p1[0], p1[1])));
    std::cout << " OK" << std::endl;
    ...
    std::cout << " [Test 11]";
    assert(bp::inside(u_poly, pPoint(50.738, 129.225)));
    std::cout << " OK" << std::endl;
